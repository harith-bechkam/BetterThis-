    ...
    <>
        ...
        <div className="footer-container">
          <div className="footer-column company-info">
            <div className="footerlogo">
              <span className="footerlogo-icon"><img src={'https://www.heliolunar.in/asset/image/final3.png'} width={"32px"} height={"32px"} /></span>
              <span className="footerlogo-text">heliolunar</span>
            </div>
            <p><strong>Email</strong><br />kaleeswaran.b@heliolunar.in</p>
            <p><strong>Phone Number</strong><br />+91 6380319582</p>
            <p><strong>Address</strong><br />18,sentamil 11th street parasakthinagar avaniyapuram<br />Madurai-625012</p>
          </div>
          ...
          <div className="footer-column quick-links">
            ...
            <ul>
              ...
              {/* <li>Services</li> */}
              <li onClick={handleAbout}>Inside heliolunar</li>
      ...
      <div className="footer-end-bottom">
        <div className="footer-bottom">
          ...
          <p>© Copyright {new Date().getFullYear()} heliolunar Technology Solutions </p>
