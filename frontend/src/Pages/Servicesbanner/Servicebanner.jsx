...
const Servicebanner = () => {
  ...
  return (
    ...
    <Container className="text-center py-5">
      {/* Heading */}
      <h2 className="fw-bold mb-4 fade-in">Flexible Engagement, Tailored To Your Vision</h2>
      ...
      <p className="lead mx-auto fade-in" style={{ maxWidth: "900px" }}>
        ...
        engagement models designed to align with your distinct business objectives
        and operational nuances. Be it a project-based collaboration, a dedicated
        team to augment your existing resources, or a consultative partnership,
        we mold our approach to fit your vision. Our adaptive models ensure that,
        together, we can navigate challenges efficiently, capitalize on opportunities
        swiftly, and ensure that our collaboration remains as dynamic and results-driven
        as the solutions we craft.
      </p>
